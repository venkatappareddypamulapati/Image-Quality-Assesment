...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep  6 17:33:26 2022
...
if __name__ == "__main__":
    ...
    img=cv2.imread('/home/venkat/Data Set/img1.png')[:300, :300, :]
...
#IMFS_sum=np.sum(IMFs[2:imfNo], axis=0)        
#plt.figure()
#plt.imshow(IMFS_sum, cmap='gray')