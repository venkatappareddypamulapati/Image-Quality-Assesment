...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 12 11:55:33 2022
...
#%% Blur the image        
        ...
        ellip_kernel=cv2.getStructuringElement(cv2.MORPH_ELLIPSE,(a,b))
        
        #kernel=np.ones((5,5))/25
        
        ellip_kernel = np.array(ellip_kernel/ellip_kernel.sum(), dtype=np.float64)
        
       # blurred = cv2.filter2D(img1, -1, ellip_kernel)
        
        blurred=conv2(img1,ellip_kernel , 'same')
...
#%% Add noise to the blurred image    
    ...
    #%% Generate deblurred image using Richardson_lucy algorithm
        ...
        """ dummy_psf=[[1.49206225e-02, 1.49206225e-02, 1.01492062e+00, 4.01492062e+00,
          9.01492062e+00],
         [3.87709227e+00, 3.87709227e+00, 4.87709227e+00, 7.87709227e+00,
          1.28770923e+01],
         [4.11765264e+00, 4.11765264e+00,5.11765264e+00, 8.11765264e+00,
          1.31176526e+01],
         [4.88694204e-01, 4.88694204e-01, 1.48869420e+00, 4.48869420e+00,
          9.48869420e+00],
         [5.22488028e-03, 5.22488028e-03, 1.00522488e+00, 4.00522488e+00,
          9.00522488e+00]]"""
        
        """dummy_psf=[[-9.89037910e-01, -9.89037910e-01,  1.09620900e-02,  3.01096209e+00,
           3.01096209e+00,  8.01096209e+00,  1.50109621e+01],
         [-9.90478422e-01, -9.90478422e-01,  9.52157760e-03,  3.00952158e+00,
           3.00952158e+00,  8.00952158e+00,  1.50095216e+01],
         [-9.91817505e-01, -9.91817505e-01,  8.18249469e-03,  3.00818249e+00,
           3.00818249e+00,  8.00818249e+00,  1.50081825e+01],
         [-9.93055159e-01, -9.93055159e-01,  6.94484128e-03,  3.00694484e+00,
           3.00694484e+00,  8.00694484e+00,  1.50069448e+01],
         [-9.94191383e-01, -9.94191383e-01,  5.80861735e-03, 3.00580862e+00,
           3.00580862e+00,  8.00580862e+00,  1.50058086e+01],
         [-9.95226177e-01, -9.95226177e-01,  4.77382291e-03,  3.00477382e+00,
           3.00477382e+00,  8.00477382e+00,  1.50047738e+01],
         [-9.96159542e-01, -9.96159542e-01,  3.84045796e-03,  3.00384046e+00,
           3.00384046e+00,  8.00384046e+00 , 1.50038405e+01]]"""
        
        
        """dummy_psf=[[-9.89037910e-01,  1.09620900e-02,  3.01096209e+00,
                 8.01096209e+00,  1.50109621e+01],
               [-9.91160643e-01,  8.83935746e-03,  3.00883936e+00,
                 8.00883936e+00,  1.50088394e+01],
               [-9.93055159e-01,  6.94484128e-03,  3.00694484e+00,
                 8.00694484e+00,  1.50069448e+01],
               [-9.94721459e-01,  5.27854144e-03,  3.00527854e+00,
                 8.00527854e+00,  1.50052785e+01],
               [-9.96159542e-01,  3.84045796e-03,  3.00384046e+00,
                1.01015776e+00, 1.01015776e+00, 4.01015776e+00, 4.01015776e+00,
                4.01015776e+00, 4.01015776e+00, 9.01015776e+00],
               [9.45270063e-03, 9.45270063e-03, 9.45270063e-03, 9.45270063e-03,
                9.45270063e-03, 1.00945270e+00, 1.00945270e+00, 1.00945270e+00,
                1.00945270e+00, 1.00945270e+00, 4.00945270e+00, 4.00945270e+00,
                4.00945270e+00, 4.00945270e+00, 9.00945270e+00],
               [8.77299842e-03, 8.77299842e-03, 8.77299842e-03, 8.77299842e-03,
                8.77299842e-03, 1.00877300e+00, 1.00877300e+00, 1.00877300e+00,
                1.00877300e+00, 1.00877300e+00, 4.00877300e+00, 4.00877300e+00,
                4.00877300e+00, 4.00877300e+00, 9.00877300e+00],
               [8.11865358e-03, 8.11865358e-03, 8.11865358e-03, 8.11865358e-03,
                8.11865358e-03, 1.00811865e+00, 1.00811865e+00, 1.00811865e+00,
                1.00811865e+00, 1.00811865e+00, 4.00811865e+00, 4.00811865e+00,
                4.00811865e+00, 4.00811865e+00, 9.00811865e+00],
               [7.48966612e-03, 7.48966612e-03, 7.48966612e-03, 7.48966612e-03,
                7.48966612e-03, 1.00748967e+00, 1.00748967e+00, 1.00748967e+00,
                1.00748967e+00, 1.00748967e+00, 4.00748967e+00, 4.00748967e+00,
                4.00748967e+00, 4.00748967e+00, 9.00748967e+00],
               [6.88603603e-03, 6.88603603e-03, 6.88603603e-03, 6.88603603e-03,
                6.88603603e-03, 1.00688604e+00, 1.00688604e+00, 1.00688604e+00,
                1.00688604e+00, 1.00688604e+00, 4.00688604e+00, 4.00688604e+00,
                4.00688604e+00, 4.00688604e+00, 9.00688604e+00],
               [6.30776332e-03, 6.30776332e-03, 6.30776332e-03, 6.30776332e-03,
                6.30776332e-03, 1.00630776e+00, 1.00630776e+00, 1.00630776e+00,
                1.00630776e+00, 1.00630776e+00, 4.00630776e+00, 4.00630776e+00,
                4.00630776e+00, 4.00630776e+00, 9.00630776e+00],
               [5.75484797e-03, 5.75484797e-03, 5.75484797e-03, 5.75484797e-03,
                5.75484797e-03, 1.00575485e+00, 1.00575485e+00, 1.00575485e+00,
                1.00575485e+00, 1.00575485e+00, 4.00575485e+00, 4.00575485e+00,
                4.00575485e+00, 4.00575485e+00, 9.00575485e+00],
               [5.22729000e-03, 5.22729000e-03, 5.22729000e-03, 5.22729000e-03,
                5.22729000e-03, 1.00522729e+00, 1.00522729e+00, 1.00522729e+00,
                1.00522729e+00, 1.00522729e+00, 4.00522729e+00, 4.00522729e+00,
                4.00522729e+00, 4.00522729e+00, 9.00522729e+00]] """
        ...
        deconvolved_RL = restoration.richardson_lucy(blurred, dummy_psf , num_iter=2)
