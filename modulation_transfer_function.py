...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec  1 11:35:55 2022
...
class ROI_selection(object):
    ...
    def __init__(self, filename):
        self.filename = filename
        self.image_data = io.imread(filename, 0)
...
if __name__ == '__main__':
    ...
    filename='/home/venkat/Data_Set/Img5.tif'
    parser.add_argument('/home/venkat/Data_Set/Img5.tif', help='String Filepath')
    args = parser.parse_args()
    #filename = read(args.filepath)
    ROI_selection(args.filename)
